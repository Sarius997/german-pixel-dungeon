 ...
 */
package com.sarius.germanpixeldungeon.items.weapon.enchantments;
...
public class Poison extends Weapon.Enchantment {
	...
	public boolean proc( Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			Buff.affect( defender, com.sarius.germanpixeldungeon.actors.buffs.Poison.class ).
				set( com.sarius.germanpixeldungeon.actors.buffs.Poison.durationFactor( defender ) * (level + 1) );
