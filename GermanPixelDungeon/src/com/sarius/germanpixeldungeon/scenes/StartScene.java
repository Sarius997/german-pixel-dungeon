...
import com.sarius.germanpixeldungeon.effects.BannerSprites.Type;
import com.sarius.germanpixeldungeon.ui.Archs;
import com.sarius.germanpixeldungeon.ui.ExitButton;
import com.sarius.germanpixeldungeon.ui.Icons;
import com.sarius.germanpixeldungeon.ui.RedButton;
import com.sarius.germanpixeldungeon.utils.Utils;
import com.sarius.germanpixeldungeon.windows.WndChallenges;
import com.sarius.germanpixeldungeon.windows.WndClass;
import com.sarius.germanpixeldungeon.windows.WndMessage;
import com.sarius.germanpixeldungeon.windows.WndOptions;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		curClass = null;
		updateClass( HeroClass.values()[GermanPixelDungeon.lastClass()] );
	...
	private void startNewGame() {
		...
		if (GermanPixelDungeon.intro()) {
			GermanPixelDungeon.intro( false );
	...
	protected void onBackPressed() {
		GermanPixelDungeon.switchNoFade( TitleScene.class );
	}
	...
	private class ChallengeButton extends Button {
		...
		protected void createChildren() {
			...
			image = Icons.get( GermanPixelDungeon.challenges() > 0 ? Icons.CHALLENGE_ON :Icons.CHALLENGE_OFF );
			add( image );
		}
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				add( new WndChallenges( GermanPixelDungeon.challenges(), true ) {
					public void onBackPressed() {
						super.onBackPressed();
						image.copy( Icons.get( GermanPixelDungeon.challenges() > 0 ? 
