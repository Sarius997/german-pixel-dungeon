...
public class Journal {
	...
	public static enum Feature {
		WELL_OF_HEALTH			( "Brunnen der Heilung" ),
		WELL_OF_AWARENESS		( "Brunnen der Erkaenntnis" ),
		WELL_OF_TRANSMUTATION	( "Brunnen der Umwandlung" ),
		ALCHEMY					( "Alchemietopf" ),
		GARDEN					( "Garten" ),
		STATUE					( "Lebendige Statue" ),
		
		GHOST					( "Trauriger Geist" ),
		WANDMAKER				( "Alter Stabmacher" ),
		TROLL					( "Trollschmiede" ),
		IMP						( "Ehrgeiziger Wichtel" );
