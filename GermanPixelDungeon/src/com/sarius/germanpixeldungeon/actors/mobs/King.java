...
import com.sarius.germanpixeldungeon.items.ArmorKit;
...
import com.sarius.germanpixeldungeon.sprites.KingSprite;
import com.sarius.germanpixeldungeon.sprites.UndeadSprite;
...
public class King extends Mob {
	...
	public void die( Object cause ) {
		...
		yell( "Du kannst mich nicht toeten, " + Dungeon.hero.heroClass.title() + "... Ich bin... unsterblich..." );
	}
	...
	undeadLabel:
		...
		yell( "Erhebt euch, Sklaven!" );
	}
	
	@Override
	public void notice() {
		super.notice();
		yell( "Wie kannst du es wagen!" );
	}
	
	@Override
	public String description() {
		return
			"Der letzte Koenig der Zwerge war fuer sein tiefes Verstaendnis fuer die Prozesse von Leben und Tod bekannt. " +
			"Er hat seinen Hofstaat zur Teilnahme einem Ritual ueberredet, das ihnen ewige Jugend garantieren sollte. "	+ 
			"Am Ende war er der einzige der sie erlangt hat - und er bekam eine Armee von Untoten als Bonus.";
	}
	...
	public static class Undead extends Mob {
		...
		public String description() {
			return
				"Diese untoten Zwerge, auferweckt durch den Willen des Koenigs der Zwerge, waren Teil seines Hofstaats. " +
				"Sie erscheinen als Skelette mit einem atemberaubenden Bartwuchs.";
		}
