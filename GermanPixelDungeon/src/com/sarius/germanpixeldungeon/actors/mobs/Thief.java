...
import com.sarius.germanpixeldungeon.sprites.ThiefSprite;
...
public class Thief extends Mob {
	...
	protected static final String TXT_STOLE	= "%s hat %s von dir gestolen!";
	protected static final String TXT_CARRIES	= "\n\n%s hat ein/e _%s_ bei sich. Offensichtlich gestohlen.";
	
	public Item item;
	
	{
		name = "Verruekter Dieb";
	...
	public String description() {
		String desc =
			"Tiefere Ebenen des Verlieses waren schon immer ein Versteck fuer alle Arten von Kriminellen. " +
			"Nicht alle von ihnen konnten nach so langer Zeit ohne Tageslicht bei klarem Verstand bleiben. " +
			"Diese verrueckten Diebe und Banditen haben schon vor langer Zeit vergessen, wer sie sind und warum sie stehlen.";
