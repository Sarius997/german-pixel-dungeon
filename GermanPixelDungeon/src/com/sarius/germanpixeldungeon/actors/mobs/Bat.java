...
import com.sarius.germanpixeldungeon.sprites.BatSprite;
import com.watabou.utils.Random;

public class Bat extends Mob {

	{
		name = "Vampierfledermaus";
	...
	public String description() {
		return
			"Diese lebhaften und zaehen Bewohner von Hoelen koennen viel groessere Gegner besiegen indem sie " +
			"ihr Leben bei jeder erfolgreichen Attacke auffuellen.";
	}
