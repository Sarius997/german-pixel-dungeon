...
import com.sarius.germanpixeldungeon.sprites.BruteSprite;
...
public class Brute extends Mob {
	...
	private static final String TXT_ENRAGED = "%s wird wuetend!";
	...
	public String description() {
		return
			"Wuestlinge sind die groessten, staerksten und zaehesten von allen Gnollen. Wenn sie schwer verwundet sind, " +
			"werden sie rasend und verursachen sogar mehr Schanden als ihre Feinde.";
	}
