...
import com.sarius.germanpixeldungeon.actors.blobs.Web;
...
import com.sarius.germanpixeldungeon.sprites.SpinnerSprite;
...
public class Spinner extends Mob {
	...
	public String description() {		
		return 
			"Diese gruenlichen pelzigen Hoelenspinnen versuchen es direkten Kampf aus dem Weg zu gehen, " + 
			"sondern bevorzugen es in der Entfernung darauf zu warten, dass ihr Opfer, das im Spinnennetz festhaengt" +
			"langsam an ihrem giftigen Biss stirbt.";
	}
