...
import com.sarius.germanpixeldungeon.effects.Wound;
...
public abstract class Mob extends Char {
	...
	private static final String	TXT_DIED	= "Du hoerst, dass etwas in der Enfernung gestorben ist";
	...
	private class Sleeping implements AiState {
		...
		@Override
		public String status() {
			return String.format( "Diese/r %s schlaeft", name );
		}
	}
	...
	private class Wandering implements AiState {
		...
		@Override
		public String status() {
			return String.format( "Diese/r %s streift umher", name );
		}
	}
	...
	private class Hunting implements AiState {
		...
		@Override
		public String status() {
			return String.format( "Diese/r %s jagt", name );
		}
	}
	...
	protected class Fleeing implements AiState {
		...
		@Override
		public String status() {
			return String.format( "Diese/r %s flieht", name );
		}
	}
	...
	private class Passive implements AiState {
		...
		@Override
		public String status() {
			return String.format( "Diese/r %s ist passiv", name );
		}
	}
}
