...
import com.sarius.germanpixeldungeon.Bones;
import com.sarius.germanpixeldungeon.Dungeon;
import com.sarius.germanpixeldungeon.GamesInProgress;
...
import com.sarius.germanpixeldungeon.actors.buffs.Combo;
...
import com.sarius.germanpixeldungeon.actors.buffs.Regeneration;
import com.sarius.germanpixeldungeon.actors.buffs.Roots;
import com.sarius.germanpixeldungeon.actors.buffs.Charm;
import com.sarius.germanpixeldungeon.actors.buffs.SnipersMark;
import com.sarius.germanpixeldungeon.actors.buffs.Vertigo;
import com.sarius.germanpixeldungeon.actors.buffs.Weakness;
import com.sarius.germanpixeldungeon.actors.mobs.Mob;
import com.sarius.germanpixeldungeon.actors.mobs.npcs.NPC;
import com.sarius.germanpixeldungeon.effects.CheckedCell;
import com.sarius.germanpixeldungeon.effects.Flare;
import com.sarius.germanpixeldungeon.effects.Speck;
import com.sarius.germanpixeldungeon.items.Amulet;
import com.sarius.germanpixeldungeon.items.Ankh;
import com.sarius.germanpixeldungeon.items.DewVial;
import com.sarius.germanpixeldungeon.items.Dewdrop;
import com.sarius.germanpixeldungeon.items.Heap;
import com.sarius.germanpixeldungeon.items.Heap.Type;
...
import com.sarius.germanpixeldungeon.items.keys.GoldenKey;
import com.sarius.germanpixeldungeon.items.keys.Key;
import com.sarius.germanpixeldungeon.items.keys.SkeletonKey;
import com.sarius.germanpixeldungeon.items.keys.IronKey;
import com.sarius.germanpixeldungeon.items.potions.PotionOfStrength;
import com.sarius.germanpixeldungeon.items.rings.RingOfAccuracy;
import com.sarius.germanpixeldungeon.items.rings.RingOfDetection;
import com.sarius.germanpixeldungeon.items.rings.RingOfElements;
import com.sarius.germanpixeldungeon.items.rings.RingOfEvasion;
import com.sarius.germanpixeldungeon.items.rings.RingOfHaste;
...
import com.sarius.germanpixeldungeon.items.scrolls.ScrollOfUpgrade;
...
import com.sarius.germanpixeldungeon.levels.features.AlchemyPot;
import com.sarius.germanpixeldungeon.levels.features.Chasm;
import com.sarius.germanpixeldungeon.plants.Earthroot;
import com.sarius.germanpixeldungeon.scenes.GameScene;
import com.sarius.germanpixeldungeon.scenes.InterlevelScene;
import com.sarius.germanpixeldungeon.scenes.SurfaceScene;
import com.sarius.germanpixeldungeon.sprites.CharSprite;
import com.sarius.germanpixeldungeon.sprites.HeroSprite;
import com.sarius.germanpixeldungeon.ui.AttackIndicator;
import com.sarius.germanpixeldungeon.ui.BuffIndicator;
import com.sarius.germanpixeldungeon.ui.QuickSlot;
import com.sarius.germanpixeldungeon.utils.GLog;
import com.sarius.germanpixeldungeon.windows.WndMessage;
...
public class Hero extends Char {
	...
	private static final String TXT_LEAVE = "Man verlaesst Pixel Dungeon nicht ohne weiteres.";
	
	private static final String TXT_LEVEL_UP = "Level aufgestiegen!";
	private static final String TXT_NEW_LEVEL = 
		"Du hast Level %d erreicht! Du bist nun gesuender und konzentrierter. " +
		"Fuer dich ist es jetzt einfacher Feinde zu treffen und ihren Attacken auszuweichen.";
	
	public static final String TXT_YOU_NOW_HAVE	= "Du hast nun %s";
	
	private static final String TXT_SOMETHING_ELSE	= "Hier liegt noch etwas anderes";
	private static final String TXT_LOCKED_CHEST	= "Diese Truhe ist zugesperrt und du hast keinen passenden Schluessel";
	private static final String TXT_LOCKED_DOOR		= "Du hast keinen passenden Schluessel";
	private static final String TXT_NOTICED_SMTH	= "Du hast etwas bemerkt";
	...
	public void add( Buff buff ) {
		...
		if (sprite != null) {
			if (buff instanceof Burning) {
				GLog.w( "Du hast Feuer gefangen!" );
				interrupt();
			} else if (buff instanceof Paralysis) {
				GLog.w( "Du bist paralysiert!" );
				interrupt();
			} else if (buff instanceof Poison) {
				GLog.w( "Du bist vergiftet!" );
				interrupt();
			} else if (buff instanceof Ooze) {
				GLog.w( "Beissende Saeure zerfrisst dein Fleisch. Wasche sie weg!" );
			} else if (buff instanceof Roots) {
				GLog.w( "Du kannst dich nicht bewegen!" );
			} else if (buff instanceof Weakness) {
				GLog.w( "Du fuehlst dich geschwaecht!" );
			} else if (buff instanceof Blindness) {
				GLog.w( "Du bist geblendet!" );
			} else if (buff instanceof Fury) {
				GLog.w( "Du wirst rasend!" );
				sprite.showStatus( CharSprite.POSITIVE, "furious" );
			} else if (buff instanceof Charm) {
				GLog.w( "Du bist entzueckt!" );
			}  else if (buff instanceof Cripple) {
				GLog.w( "Du bist gelaehmt!" );
			} else if (buff instanceof Bleeding) {
				GLog.w( "Du blutest!" );
			} else if (buff instanceof Vertigo) {
				GLog.w( "Alles dreht sich um dich!" );
				interrupt();
			}
