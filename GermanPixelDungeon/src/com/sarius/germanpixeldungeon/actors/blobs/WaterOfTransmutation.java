...
import com.sarius.germanpixeldungeon.items.Generator.Category;
import com.sarius.germanpixeldungeon.items.potions.Potion;
import com.sarius.germanpixeldungeon.items.potions.PotionOfMight;
...
import com.sarius.germanpixeldungeon.items.scrolls.ScrollOfWeaponUpgrade;
...
public class WaterOfTransmutation extends WellWater {
	...
	public String tileDesc() {
		return 
			"Das Wasser des Brunnens strahlt die Macht des Veraenderns aus. " +
			"Wirf ein Item in den Brunnen um es in etwas Anderes umzuwandeln.";
	}
}
