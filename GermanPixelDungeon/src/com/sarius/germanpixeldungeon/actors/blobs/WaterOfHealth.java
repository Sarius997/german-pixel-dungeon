...
import com.sarius.germanpixeldungeon.effects.particles.ShaftParticle;
...
public class WaterOfHealth extends WellWater {
	...
	private static final String TXT_PROCCED =
		"Weil du einen Schluck genommen hast, fuehlst du dass deine Wunden komplett geheilt wurden.";
	...
	public String tileDesc() {
		return 
			"Das Wasser des Brunnens strahlt die Macht der Heilung aus. " +
			"Nimm einen Schluck um deine Wunden zu heilen und deinen Hunger zu stillen.";
	}
}
